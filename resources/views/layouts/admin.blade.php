...
<body>
        ...
        <div class="container-fluid justify-content-end">
            <div class="dropdown user-dropdown">
                <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <span class="d-none d-md-inline ms-2">{{ Auth::guard('admin')->user()->name ?? Auth::user()->name }}</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <span class="dropdown-item-text text-muted small">
                            {{ Auth::guard('admin')->user()->email ?? Auth::user()->email }}
                        </span>
                    </li>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <a href="{{ route('admin.dashboard') }}">Akaw<span>nt</span></a>
        </div>
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-item">
                <a href="{{ route('admin.management.index') }}" class="sidebar-nav-link {{ request()->routeIs('admin.management.*') ? 'active' : '' }}">
